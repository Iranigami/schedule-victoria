...
export default function Teacher() {
  ...
  const [data, setData] = useState<Teacher>(
    {
      photo: "https://cs10.pikabu.ru/post_img/big/2019/06/25/8/15614688111117407.jpg",
    ...
    <div className="w-[1568px] h-[1080px] p-[24px]">
      <div className="w-[1520px] h-[64px] flex gap-[16px] justify-left items-center">
        ...
        <div className="w-[504px] h-[64px] rounded-[20px] bg-white gap-[8px] flex p-[8px]">
          <div className={`w-[240px] h-[48px] z-0 absolute bg-orange rounded-[12px] duration-150 transition ${page && "translate-x-[248px]"}`}/>
          <button 
            onClick={() => setPage(0)}
                  ...
                  <div className="w-[766px]">
                    ...
                    <div className="w-[766px] rounded-[20px] bg-[#F1852233] p-[24px] text-text mt-[16px]">
                      ...
                      {data.classes.map((lesson, index: number) => (
                        <span key={index}>{lesson}{index+1 !== data.classes.length && ", "}</span>
                      ))}
                      </div>
                    </div>
                    <div hidden={!data.awards} className="w-[766px] rounded-[20px] bg-[#F1852233] p-[24px] text-text mt-[16px]">
